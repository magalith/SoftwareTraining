...
for ( var i = 0; i < data.length; i++) {//循环json对象，拼接tr,td的html
    ...
    html = html + '<td style="width: 160px"><form action="#" method="post"><div class="input-group"><input type="text" name="message" placeholder="总分" class="form-control input-sm" style="width: 60px"><button type="submit" class="btn btn-primary btn-flat btn-sm">评分</button></div></form></td>';
    html = html + '</tr>';
}
